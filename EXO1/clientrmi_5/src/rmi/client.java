...
public class client {
    ...
    public double exe_cli_game (double a,String c,String u,String ee) throws NotBoundException, MalformedURLException, RemoteException, ServerNotActiveException{
